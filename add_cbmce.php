...
if ($_POST) {
    ...
    try {
        $sql = "INSERT INTO bombeiros (nome, setor, contato, email) VALUES (?, ?, ?, ?)";
        $stmt = $pdo->prepare($sql);
        $stmt->execute([$nome, $setor, $contato, $email]);
        $sucesso = 'Bombeiros cadastrado com sucesso!';
    } catch (Exception $e) {
...
<html>
<head>
    <title>Cadastrar Contatos do Bombeiros</title>
    <link rel="stylesheet" href="style.css">
</head>
<body>
<div class="container">
    <h2>Cadastrar Contatos do Corpo de Bombeiros</h2>
    <form method="POST">
        <label>Nome:</label>
